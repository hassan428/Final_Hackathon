...
export const Third_screen = () => {
    ...
    return (
        <View style={[container]}>
            <Image resizeMode='contain' source={require('../assets/third_screen_img.jpeg')} />

            <View style={[get_start_view]}>

                <Start_screen_text text={'Task Management'} />

                <Start_screen_title firstText={"Manage your"} colorText={'Tasks'} lastText={'quickly for Results✌'} />
