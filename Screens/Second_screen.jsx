...
export const Second_screen = () => {
    ...
    const { container, get_start_view, title_style, fontFamily, text_style, btn_view, progress_view } = styles;
    return (
        <View style={[container]}>
            <Image resizeMode='contain' source={require('../assets/second_screen_img.jpeg')} />

            <View style={[get_start_view]}>

                <Start_screen_text text={'Task Management'} />

                <Start_screen_title firstText={"Work more"} colorText={'Structured'} lastText={'and Organized 👌'} />
                ...
                <View style={[btn_view]}>
                    <ActiveBtn text={"Skip"} onPress={() => navigation.navigate('Third_screen')} />
                    <IconButton
                        icon="arrow-right"
                        iconColor={primary}
                        size={20}
